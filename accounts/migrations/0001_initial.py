# Generated by Django 3.2 on 2021-07-21 19:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_owner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, to_field='username')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imei', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='accounts.devicetable')),
                ('sold_to', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, to_field='username')),
            ],
            options={
