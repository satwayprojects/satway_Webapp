...
class CreateSubDealerForm2(forms.Form):
    ...
    def clean(self):
        cleaned_data = super(CreateSubDealerForm2, self).clean()
        ...
        return cleaned_data
class CreateSubDealerForm1(UserCreationForm):
    password1 = None # Standard django password input
    password2 = None # Standard django password confirmation input
    class Meta:
        model = User
...
class AllocateDevice(forms.Form):
    ...
    imei = forms.CharField(max_length=15,min_length=15,required=False,validators=[RegexValidator(r'^\d{1,10}$')], help_text="IMEI to be allocated", widget= forms.TextInput
...
class AllocateDeviceUser(forms.Form):
    ...
    imei = forms.CharField(max_length=15,min_length=15,validators=[RegexValidator(r'^\d{1,15}$')], help_text="IMEI to be allocated", widget= forms.TextInput
...
class DeviceVehicleAllocationForm(models.ModelForm):
    ...
    #         # css_class > For styling the Input Box
    #         #Field('password2', css_class='form-control',style="width: 280px"),
    #         Field('vehicle_no'),
    #         Field('installation_date'),
    #         Field('odometer'),

    #         #Submit('submit',"Allocate User", css_class="btn-success")
    #     )
